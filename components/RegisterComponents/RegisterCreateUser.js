...
const RegisterCreateUser = ({navigation,theme}) => {
  ...
  return (
    ...
    <View style = {styles.Register__LogoContainer}>
      <Image source={theme === 'light'?require('../../pictures/Logos/LOGO_WA_LIGHT.png'):require('../../pictures/Logos/LOGO_WA_DARK.png')} style = {styles.Register__Logo} /> 
   </View>
   ...
   <View style = {styles.Register__Form}>
    ...
    {/* button to show or hide password */}
     ...
     <TouchableOpacity style = {styles.Register__ButtonCancel}
     onPress = {()=>{navigation.navigate("Login")}}>
         <Text style = {{color:"#505050",textAlign:"center"}}>Cancel</Text>
     </TouchableOpacity>
   </View>
 </View>
  )
